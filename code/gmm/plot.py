...
def main():
    ...
    iwae_reinforce_log_evidence_history, iwae_reinforce_elbo_history, iwae_reinforce_p_mixture_probs_ess_history, iwae_reinforce_p_mixture_probs_norm_history, iwae_reinforce_p_grad_std_history, iwae_reinforce_q_grad_std_history = np.load('iwae_reinforce_log_evidence_history.npy'), np.load('iwae_reinforce_elbo_history.npy'), np.load('iwae_reinforce_p_mixture_probs_ess_history.npy'), np.load('iwae_reinforce_p_mixture_probs_norm_history.npy'), np.load('iwae_reinforce_p_grad_std_history.npy'), np.load('iwae_reinforce_q_grad_std_history.npy')

    iwae_vimco_log_evidence_history, iwae_vimco_elbo_history, iwae_vimco_p_mixture_probs_ess_history, iwae_vimco_p_mixture_probs_norm_history, iwae_vimco_p_grad_std_history, iwae_vimco_q_grad_std_history = np.load('iwae_vimco_log_evidence_history.npy'), np.load('iwae_vimco_elbo_history.npy'), np.load('iwae_vimco_p_mixture_probs_ess_history.npy'), np.load('iwae_vimco_p_mixture_probs_norm_history.npy'), np.load('iwae_vimco_p_grad_std_history.npy'), np.load('iwae_vimco_q_grad_std_history.npy')

    ws_log_evidence_history, ws_p_mixture_probs_ess_history, ws_p_mixture_probs_norm_history, ws_p_grad_std_history, ws_q_grad_std_history = np.load('ws_log_evidence_history.npy'), np.load('ws_p_mixture_probs_ess_history.npy'), np.load('ws_p_mixture_probs_norm_history.npy'), np.load('ws_p_grad_std_history.npy'), np.load('ws_q_grad_std_history.npy')

    ww_log_evidence_history, ww_p_mixture_probs_ess_history, ww_p_mixture_probs_norm_history, ww_p_grad_std_history, ww_q_grad_std_history = np.load('ww_log_evidence_history.npy'), np.load('ww_p_mixture_probs_ess_history.npy'), np.load('ww_p_mixture_probs_norm_history.npy'), np.load('ww_p_grad_std_history.npy'), np.load('ww_q_grad_std_history.npy')

    wsw_log_evidence_history, wsw_p_mixture_probs_ess_history, wsw_p_mixture_probs_norm_history, wsw_p_grad_std_history, wsw_q_grad_std_history = np.load('wsw_log_evidence_history.npy'), np.load('wsw_p_mixture_probs_ess_history.npy'), np.load('wsw_p_mixture_probs_norm_history.npy'), np.load('wsw_p_grad_std_history.npy'), np.load('wsw_q_grad_std_history.npy')
