...
def main():
    ...
    parser.add_argument('--relax-lr', help='Adam learning rate for RELAX', type=float, default=0.00005)
    parser.add_argument('--relax-c-lr-scale', help='Scaling factor for the learning rate for the control variate in RELAX', type=float, default=1)
    parser.add_argument('--relax-c-weight-decay', help='Weight decay for the control variate in RELAX', type=float, default=0.001)
    parser.add_argument('--cdae-lr', help='Adam learning rate for CDAE', type=float, default=0.001)
